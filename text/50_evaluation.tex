...
\begin{table}[]
    ...
    \begin{tabular}{c||c|c|c|c}
     window \textbackslash{} distance & 0.10 & 0.15 \\ \hline \hline
     3s & 0.3713 / 0.0194 & 0.7481 / 0.1666 \\ \hline
     5s & 0.4473 / 0.0605 & 0.8439 / 0.2767 \\ \hline
     10s & 0.6268 / 0.1647 & 0.8573 / 0.6776 \\ \hline
     15s & 0.6666 / 0.1677 & 0.8578 / 0.6779 
    \end{tabular}
    \caption[Comparison of various hyperparameters for direct identity construction]{Comparison of various hyperparameters for direct identity construction with separate time window for metadata. In each cell there is \gls{tpr} / \gls{fpr} for given threshold for merging using corresponing threshold for cosine distance.}
    \label{tab:direct_time_window}
    \todo[inline=true]{check popisek}
\end{table}