...
\def\Dedication{%
Firstly I would like thank my supervisor prof. RNDr. Tomáš Skopal, Ph.D. for all the patient guidance and valuable advice. I would also like to extend my gratitude to my friends and family for all the support. Finally, I would like thank my girlfriend for the enormous help and encouragement during my studies and, especially, writing this thesis.
}
...
\include{text/00_introduction}
\include{text/05_preliminaries}
\include{text/10_related_work}
\include{text/20_formulation_and_workflow}
\include{text/30_feature_extraction}
\include{text/40_identity_construction}
\include{text/50_evaluation}
\include{text/55_implementation}
\include{text/60_conclusion}
